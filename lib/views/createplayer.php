<form action="" method="post">
    <fieldset>
        ...
        <div class="control-group<?php echo ($data["name_error"] != "" ? " error" : ""); ?>">
            ...
            <div class="controls">
                <input type="text" placeholder="Type players name" id="name" name="name" value="<? echo $data["name"]; ?>">
        ...
        <div class="control-group<?php echo ($data["nickname_error"] != "" ? " error" : ""); ?>">
            ...
            <div class="controls">
                <input type="text" placeholder="Type players nickname" id="nickname" name="nickname" value="<? echo $data["nickname"]; ?>">
